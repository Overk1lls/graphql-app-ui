    ...
    <div className="container pt-5 my-5">
        <div className="row">
            <div className="col-lg-7 order-2 order-lg-1 content">
                ...
                <p>
                    Переходьте на особисту сторінку користувача для аналізу ваших дій та
                    ефективності навчання за останні роки на ресурсі E-Olymp. Зробіть якісну оцінку
                    вашим знанням для кожного року окремо. Отримайте:
                </p>
                <ul>
                    <li>
                        <svg
